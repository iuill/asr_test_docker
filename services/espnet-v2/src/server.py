...
speech recognition service using reazonspeech-espnet-v2.
"""
...
app = FastAPI(
    title="ReazonSpeech Real-time ASR (ESPnet)",
    description="Real-time speech recognition using reazonspeech-espnet-v2",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def get_index():
    ...
    if index_path.exists():
        ...
        return HTMLResponse(
            ...
            <!DOCTYPE html>
            <html>
            <head><title>ReazonSpeech ASR (ESPnet)</title></head>
            <body>
                <h1>ReazonSpeech Real-time ASR (ESPnet)</h1>
