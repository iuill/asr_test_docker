/**
 * ReazonSpeech Real-time ASR Client (ESPnet)
 *
 * This script handles:
...
class ASRClient {
    ...
    drawVisualizer() {
        ...
        for (let i = 0; i < bufferLength; i++) {
            ...
            // Gradient from green to teal (ESPnet theme)
            const hue = 160 + (dataArray[i] / 255) * 20;
            this.canvasCtx.fillStyle = `hsl(${hue}, 70%, 40%)`;
