"""
Main entry point for OpenAI Speech-to-Text ASR service (gpt-4o-mini-transcribe).
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="OpenAI Speech-to-Text Real-time ASR Server (gpt-4o-mini-transcribe)"
    )
    parser.add_argument(
        "--host",
        type=str,
    ...
    parser.add_argument(
        "--model",
        type=str,
        default=os.environ.get("OPENAI_MODEL", "gpt-4o-mini-transcribe"),
