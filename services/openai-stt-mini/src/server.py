...
OpenAI Speech-to-Text service using gpt-4o-mini-transcribe.
"""
...
async def lifespan(app: FastAPI):
    ...
    model = getattr(app.state, "model", "gpt-4o-mini-transcribe")
...
app = FastAPI(
    title="OpenAI Speech-to-Text ASR (gpt-4o-mini-transcribe)",
    description="Real-time speech recognition using OpenAI gpt-4o-mini-transcribe",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def websocket_asr(websocket: WebSocket):
    """
    WebSocket endpoint for real-time ASR using OpenAI gpt-4o-mini-transcribe.
