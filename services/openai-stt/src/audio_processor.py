"""
Audio processing utilities for OpenAI Speech-to-Text.
...
def int16_bytes_to_base64(audio_bytes: bytes) -> str:
    """
    Encode 16-bit PCM audio bytes to base64 string.
...
def resample_audio(
    ...
    Args:
        ...
        target_rate: Target sample rate (default: 24000 for OpenAI)
